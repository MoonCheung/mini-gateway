import { Column, ObjectID, Entity, ObjectIdColumn, UpdateDateColumn } from 'typeorm'
...
export class User {
  ...
  @Column({ default: null }) mobile?: string;
  @Column({ default: null }) enName?: string;
  @Column({ default: null }) feishuUnionId?: string;
  @Column({ default: null }) feishuUserId?: string;
  @Column({ default: null }) departmentName?: string;
